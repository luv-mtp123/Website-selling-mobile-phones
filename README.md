...
Chạy file script tạo dự án bạn vừa tải về: python setup\_project.py
...
Tôi đã chuẩn bị sẵn script để tạo User Admin và một vài điện thoại mẫu. Chạy lệnh: python seed\_data.py
...
Khởi động website: python manage.py runserver
