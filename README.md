...
* **✅ Động Cơ Tìm Kiếm Bằng Hình Ảnh (Visual AI Search - Nâng cấp V3):**
	...
	* **Tự Động Nâng Cấp Ảnh (Auto-Enhance):** Tích hợp công nghệ xử lý ảnh ImageEnhance tự động kích thích độ sắc nét lên 150% và tương phản lên 110% trước khi AI đọc, giúp nhìn xuyên thấu các chi tiết bị mờ hoặc tối.
